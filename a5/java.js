$(document).ready(function(){
	...
	var i;
	var recpies= ["Breakfast Bars", "Marbled Blondies", "Strawberry Shortcake","Carrot Cake Cookies"]

	$("#recpiesButton").click(function(){
		for (i = 0; i < recpies.length; i++){
			$("#cook").append(recpies[i] + "<br>")
		}
	})
